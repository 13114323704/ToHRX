...
public class SlideSample {
    public static void play(TextSurface textSurface) {
        ...
        Text textA = TextBuilder.create("you ,何瑞欣").build();
        Text textB = TextBuilder.create("i ,黄庆庆  ").setPosition(Align.LEFT_OF, textA).build();
        Text textC = TextBuilder.create("I will be with you").setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textB).build();
        Text textD = TextBuilder.create("Forever!").setPadding(10, 10, 10, 10).setPosition(Align.BOTTOM_OF | Align.CENTER_OF, textC).build();
        int duration = 5000;
